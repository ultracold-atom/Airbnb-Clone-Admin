  ...
  <main>
    <div class="cards">
        ...
        <div class="form-section">
          <h1 class="form-heading">Earn money as an Airbnb host</h1>
          <h2 class="form-subheading">Tell us a little about your place</h2>
...
export default {
  data() {
    return {
      categories: ["House","Bungalov","TreeHouses","Island","North Pole","Cave","Castle","Estate","National Park","Tower","Tropical","Landscape"],
